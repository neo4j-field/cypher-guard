      ...
      case 'arm64':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('cypher-guard-android-arm64')
          }
        } catch (e) {
          loadError = e
        }
      ...
      case 'arm':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('cypher-guard-android-arm-eabi')
          }
        } catch (e) {
          loadError = e
        }
      ...
      case 'x64':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('cypher-guard-win32-x64-msvc')
          }
        } catch (e) {
          loadError = e
        }
      ...
      case 'ia32':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('cypher-guard-win32-ia32-msvc')
          }
        } catch (e) {
          loadError = e
        }
      ...
      case 'arm64':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('cypher-guard-win32-arm64-msvc')
          }
        } catch (e) {
          loadError = e
        }
  ...
  case 'darwin':
    ...
    try {
      if (localFileExisted) {
        ...
        nativeBinding = require('cypher-guard-darwin-universal')
      }
      break
    } catch {}
    switch (arch) {
      case 'x64':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('cypher-guard-darwin-x64')
          }
        } catch (e) {
          loadError = e
        }
      ...
      case 'arm64':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('cypher-guard-darwin-arm64')
          }
        } catch (e) {
          loadError = e
        }
  ...
  case 'freebsd':
    ...
    try {
      if (localFileExisted) {
        ...
        nativeBinding = require('cypher-guard-freebsd-x64')
      }
    } catch (e) {
      loadError = e
    }
        ...
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('cypher-guard-linux-x64-musl')
            }
          } catch (e) {
            loadError = e
          }
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('cypher-guard-linux-x64-gnu')
            }
          } catch (e) {
            loadError = e
          }
        ...
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('cypher-guard-linux-arm64-musl')
            }
          } catch (e) {
            loadError = e
          }
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('cypher-guard-linux-arm64-gnu')
            }
          } catch (e) {
            loadError = e
          }
        ...
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('cypher-guard-linux-arm-musleabihf')
            }
          } catch (e) {
            loadError = e
          }
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('cypher-guard-linux-arm-gnueabihf')
            }
          } catch (e) {
            loadError = e
          }
        ...
        if (isMusl()) {
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('cypher-guard-linux-riscv64-musl')
            }
          } catch (e) {
            loadError = e
          }
          ...
          try {
            if (localFileExisted) {
              ...
              nativeBinding = require('cypher-guard-linux-riscv64-gnu')
            }
          } catch (e) {
            loadError = e
          }
      ...
      case 's390x':
        ...
        try {
          if (localFileExisted) {
            ...
            nativeBinding = require('cypher-guard-linux-s390x-gnu')
          }
        } catch (e) {
          loadError = e
        }
